...
This program is a server-side code to store a list of your favorite movies, including box art imagery and a movie trailer URL. 
This data is served as a web page allowing visitors to review their movies and watch the trailers.
...
C:\Users\rdale\Desktop\movie311\movies\entertainment_center.py
...
This project was assigned by the udacity full-stack nano degree program.


Instalation

This project can be obtained through GIt Hub.

Link:  https://github.com/bentgrass120/readme-file-front-end-video-project
